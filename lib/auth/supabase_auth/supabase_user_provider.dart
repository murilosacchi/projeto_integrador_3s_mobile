...
class PiMetroMobileSupabaseUser extends BaseAuthUser {
  PiMetroMobileSupabaseUser(this.user);
  User? user;
  @override
...
Stream<BaseAuthUser> piMetroMobileSupabaseUserStream() {
  ...
  return (!loggedIn
      ...
      .map<BaseAuthUser>(
    (authState) {
      currentUser = PiMetroMobileSupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}
